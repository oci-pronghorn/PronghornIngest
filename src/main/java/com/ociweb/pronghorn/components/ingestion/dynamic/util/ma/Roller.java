...
public class Roller {
    ...
    final static Logger logger = LoggerFactory.getLogger(Roller.class);
     ...
     * @return
     */
    public static double getElementAt(Roller roller, int index) {
    ...
    public static int getCount(Roller roller) {
        return (int) (roller.distance<0 ?  roller.size+roller.distance : roller.size);
    }
    
    public static double peek(Roller roller){
     ...
     */
    public static final double roll(Roller roller, double curValue) {
        if (roller.size ==0 ) {
            return curValue;
        }
    ...
    public static void print(Roller roller) {
        int i = 0;
    ...
    public static final double mean(Roller roller) {
