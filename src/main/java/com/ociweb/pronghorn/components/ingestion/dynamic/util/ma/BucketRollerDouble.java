 ...
 *
 */
public class BucketRollerDouble {
    ...
    public BucketRollerDouble(int granularity, int span, int alignment) {
    ...
    public static int span(BucketRollerDouble roller) {
        return roller.span;
    }
    
    public static int bucketsRepeatAfter(BucketRollerDouble roller) {
        return roller.span+roller.alignment;
    }

    public static void roll(BucketRollerDouble roller, double value) {
    ...
    public static double mean(BucketRollerDouble roller) { //probably don't want to use, passing accumulator would be more accurate.
        return roller.result/(double)roller.span;
    }
    
    public static double result(BucketRollerDouble roller) {
     ...
     * @return
     */
    public static double newMean(BucketRollerDouble roller) {
    ...
    public static int bucketFill(BucketRollerDouble roller) {
        return roller.accumulatorSize - roller.accumulatorCountDown;
    }
    
    public static int bucketSize(BucketRollerDouble roller) {
